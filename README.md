# Multiclassification Machine Learning | Project


## Objective
Create the best classification model of machine learning that can classificate the author (independent variable) of the scripts when certain characteristics (features) are given. 
